...
public class InstitutionSummaryConfiguration : IEntityTypeConfiguration<InstitutionSummary>
{
    public void Configure(EntityTypeBuilder<InstitutionSummary> builder)
    {
