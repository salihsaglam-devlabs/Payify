...
using LinkPara.Billing.Application;
using LinkPara.Billing.Application.Commons.Models.ElasticApmConfiguration;
using LinkPara.Billing.Application.Commons.Models.EventBusConfiguration;
using LinkPara.Billing.Infrastructure;
...
builder.Host.UseSerilog((ctx, lc) =>
{
    lc.WriteTo.Logger(new LoggerConfiguration()
        ...
        .Enrich.WithThreadId()
        .Enrich.WithProperty("ApplicationName","Billing.API")
        .WriteTo.Debug()
        .WriteTo.RabbitMQ(
...
configuration.AddInMemoryCollection(
    new Dictionary<string, string>
    {
        ...
        { "ElasticApm:ServiceName", "Billing.API" }
    });
