...
public class PaycoreCustomerService : IPaycoreCustomerService
{
    ...
    public PaycoreCustomerService(PaycoreClientService clientService, IConfiguration configuration, IVaultClient vaultClient)
    {
    ...
    public async Task<PaycoreResponse> CreateCustomerAsync(CreateCustomerCommand command)
    {
        ...
        var createCustomerRequest = new PaycoreCreateCustomerRequest
        {
            ...
            CommunicationLanguage = _paycoreSettings.VaultSettings.LanguageCode,
            CustomerGroupCode = _paycoreSettings.VaultSettings.CustomerGroupCode,
            Name = command.Name,
