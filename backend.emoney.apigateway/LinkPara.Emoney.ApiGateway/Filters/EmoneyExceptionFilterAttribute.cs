...
namespace LinkPara.Emoney.ApiGateway.Filters;

public class EmoneyExceptionFilterAttribute : ExceptionFilterAttribute
{
    private readonly IDictionary<Type, Action<ExceptionContext>> _exceptionHandlers;
    private readonly IStringLocalizer _localizer;
    private readonly ILogger<EmoneyExceptionFilterAttribute> _logger;

    public EmoneyExceptionFilterAttribute(IStringLocalizerFactory factory,
