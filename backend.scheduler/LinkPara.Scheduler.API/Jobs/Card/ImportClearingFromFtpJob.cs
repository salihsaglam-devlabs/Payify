...
public class ImportClearingFromFtpJob : IJobTrigger
{
    private readonly IBus _bus;

    public ImportClearingFromFtpJob(IBus bus)
    {
        _bus = bus;
    }
    ...
    public async Task TriggerAsync(CronJob job)
    {
        ...
        await endpoint.Send(new
        {
            ...
            ProcessType = (int)FileIngestionAndReconciliationJobType.ImportClearingFromFtp
        }, tokenSource.Token);
    }
}
