...
namespace LinkPara.CampaignManagement.IntegrationTests;
...
public class Testing
{
    ...
    public void RunBeforeAnyTests()
    {
        ...
        services.AddSingleton(Mock.Of<IWebHostEnvironment>(w =>
            ...
            w.ApplicationName == "LinkPara.CampaignManagement.API"));
        ...
        where TEntity : class
    {
        ...
        var context = scope.ServiceProvider.GetRequiredService<CampaignManagementDbContext>();
