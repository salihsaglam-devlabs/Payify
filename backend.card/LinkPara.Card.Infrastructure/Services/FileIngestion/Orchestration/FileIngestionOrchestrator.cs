...
public class FileIngestionOrchestrator : IFileIngestionService
{
        ...
        StoreObjectIdentifier storeObject)
    {
        ...
        if (entityType.ClrType == typeof(IngestionFileLineEntity))
        {
            ...
            [
                ...
                nameof(IngestionFileLineEntity.ArchiveTransitionedAt),
                nameof(IngestionFileLineEntity.ArchiveTransitionRunId),
        ...
        else if (entityType.ClrType == typeof(IngestionFileEntity))
        {
            ...
            [
                ...
                nameof(IngestionFileEntity.ArchiveRecordWrittenAt),
                nameof(IngestionFileEntity.ArchiveRecordRunId),
                nameof(IngestionFileEntity.ArchiveChildrenTransitionedAt),
                nameof(IngestionFileEntity.ArchiveCleanupEligibleAt),
                nameof(IngestionFileEntity.ArchiveCleanupCompletedAt),
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            return new TargetWriter(targetStream);
        }
        catch (Exception ex)
        {
            return new TargetWriter(null, ex.Message);
        }
    }
    ...
    private sealed class TargetWriter
    {
        ...
        public TargetWriter(Stream? stream, string? errorMessage = null)
        {
            _stream = stream;
