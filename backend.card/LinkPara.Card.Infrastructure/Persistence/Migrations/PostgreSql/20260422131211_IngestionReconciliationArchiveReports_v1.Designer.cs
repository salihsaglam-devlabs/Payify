...
namespace LinkPara.Card.Infrastructure.Persistence.Migrations.PostgreSql
{
    ...
    [Migration("20260422131211_IngestionReconciliationArchiveReports_v1")]
            ...
            modelBuilder.Entity("LinkPara.Card.Domain.Entities.FileIngestion.Persistence.IngestionFileLine", b =>
                {
                    ...
                    b.HasIndex("FileId", "LineType", "Status", "ReconciliationStatus")
                        .HasDatabaseName("ix_file_line_file_id_line_type_status_reconciliation_status");
            ...
            modelBuilder.Entity("LinkPara.Card.Domain.Entities.Reconciliation.Persistence.ReconciliationOperation", b =>
                {
                    ...
                    b.HasIndex("IdempotencyKey", "Status")
                        .HasDatabaseName("ix_operation_idempotency_key_status");
