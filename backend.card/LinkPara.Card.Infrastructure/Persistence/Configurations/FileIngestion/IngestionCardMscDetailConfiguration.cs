...
public class IngestionCardMscDetailConfiguration : IEntityTypeConfiguration<IngestionCardMscDetail>
{
    public void Configure(EntityTypeBuilder<IngestionCardMscDetail> builder)
    {
        ...
        builder.HasOne(x => x.IngestionFileLine)
            .WithOne(x => x.CardMscDetail)
            .HasForeignKey<IngestionCardMscDetail>(x => x.IngestionFileLineId);
    }

    internal static void ConfigureColumns<T>(EntityTypeBuilder<T> builder) where T : IngestionCardMscDetail
    {
