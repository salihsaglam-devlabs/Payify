...
using LinkPara.Epin.Application;
using LinkPara.Epin.Infrastructure;
...
using LinkPara.Epin.Application.Commons.Models.ElasticApmConfiguration;
...
builder.Host.UseSerilog((ctx, lc) =>
{
    lc.WriteTo.Logger(new LoggerConfiguration()
        ...
        .Enrich.WithThreadId()
        .Enrich.WithProperty("ApplicationName","Epin.API")
        .WriteTo.Debug()
        .WriteTo.RabbitMQ(
...
configuration.AddInMemoryCollection(
    new Dictionary<string, string>
    {
        ...
        { "ElasticApm:ServiceName", "Epin.API" }
    });
