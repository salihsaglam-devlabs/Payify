...
namespace LinkPara.IWallet.ApiGateway.Filters;

public class IWalletExceptionFilterAttribute : ExceptionFilterAttribute
{
    private readonly IDictionary<Type, Action<ExceptionContext>> _exceptionHandlers;
    private readonly IStringLocalizer _localizer;
    private readonly ILogger<IWalletExceptionFilterAttribute> _logger;

    public IWalletExceptionFilterAttribute(IStringLocalizerFactory factory,
        ILogger<IWalletExceptionFilterAttribute> logger)
    {
        _logger = logger;
