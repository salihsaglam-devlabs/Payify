...
namespace LinkPara.BusinessParameter.IntegrationTests;
...
public class Testing
{
    ...
    public void RunBeforeAnyTests()
    {
        ...
        services.AddSingleton(Mock.Of<IWebHostEnvironment>(w =>
            ...
            w.ApplicationName == "LinkPara.BusinessParameter.API"));
        ...
        where TEntity : class
    {
        ...
        var context = scope.ServiceProvider.GetRequiredService<BusinessParameterDbContext>();
