...
namespace LinkPara.ApiGateway.Boa.Services;
...
public class HttpClientBase
{
        ...
        IHttpContextAccessor contextAccessor)
    {
        ...
        _client.DefaultRequestHeaders.Add("Gateway", Gateway.BoaApiGateway.ToString());
    ...
    private static async Task HandleStandardException(HttpResponseMessage response)
    {
        ...
        { 
            ...
            throw new AuthorizationException(ErrorCode.Unauthorized, $"Boa Gateway UnauthorizedAccessException response.StatusCode{response.StatusCode}");
        }
