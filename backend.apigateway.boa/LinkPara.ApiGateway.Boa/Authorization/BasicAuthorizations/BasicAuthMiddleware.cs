...
namespace LinkPara.ApiGateway.Boa.Authorization.BasicAuthorizations;
...
public class BasicAuthMiddleware
{
    ...
    public async Task Invoke(HttpContext context)
    {
        ...
        var credentials = await _vaultClient.GetSecretValueAsync<ClientList>("BoaGatewaySecrets", "Credentials");
