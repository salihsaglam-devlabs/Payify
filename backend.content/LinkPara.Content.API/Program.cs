...
using LinkPara.Content.Application;
using LinkPara.Content.Infrastructure;
...
using LinkPara.Content.Application.Commons.Models.ElasticApmConfiguration;
...
builder.Host.UseSerilog((ctx, lc) =>
{
    lc.WriteTo.Logger(new LoggerConfiguration()
        ...
        .Enrich.WithThreadId()
        .Enrich.WithProperty("ApplicationName","Content.API")
        .WriteTo.Debug()
        .WriteTo.RabbitMQ(
...
configuration.AddInMemoryCollection(
    new Dictionary<string, string>
    {
        ...
        { "ElasticApm:ServiceName", "Content.API" }
    });
