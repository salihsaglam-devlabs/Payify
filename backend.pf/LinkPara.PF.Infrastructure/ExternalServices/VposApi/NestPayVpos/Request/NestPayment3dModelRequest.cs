...
public class NestPayment3dModelRequest : NestPayBaseRequest
{
    ...
    private string BuildRequestCommon()
    {
        ...
        requestXml.AppendLine($"<PayerTxnId>{PayerTxnId}</PayerTxnId>");
        requestXml.AppendLine($"<PayerSecurityLevel>{PayerSecurityLevel}</PayerSecurityLevel>");
        requestXml.AppendLine($"<PayerAuthenticationCode>{PayerAuthenticationCode}</PayerAuthenticationCode>");
