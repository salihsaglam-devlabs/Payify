...
public class VakifPointInquiryResponse : VakifResponseBase
{
    public string TransactionType { get; set; }
    public string TotalPoint { get; set; }
    public VakifPointInquiryResponse Parse(string response)
    {
        ...
        TransactionType = responseXml.Element("TransactionType")?.Value;
        TotalPoint = responseXml.Element("TotalPoint")?.Value;
