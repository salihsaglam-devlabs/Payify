...
public class FinansPayment3DModelResponse : FinansResponseBase
{
    public FinansPayment3DModelResponse Parse(string response)
    {
        ...
        ErrorMessage = responseXml.Descendants().FirstOrDefault(node => node.Name == "ErrMsg")?.Value;
