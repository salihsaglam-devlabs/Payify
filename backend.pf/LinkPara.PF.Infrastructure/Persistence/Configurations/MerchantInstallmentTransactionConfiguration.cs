...
public class MerchantInstallmentTransactionConfiguration : IEntityTypeConfiguration<MerchantInstallmentTransaction>
{
    public void Configure(EntityTypeBuilder<MerchantInstallmentTransaction> builder)
    {
