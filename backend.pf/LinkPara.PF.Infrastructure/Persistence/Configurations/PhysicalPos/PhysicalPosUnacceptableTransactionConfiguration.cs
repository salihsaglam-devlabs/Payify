...
public class PhysicalPosUnacceptableTransactionConfiguration : IEntityTypeConfiguration<PhysicalPosUnacceptableTransaction>
{
    public void Configure(EntityTypeBuilder<PhysicalPosUnacceptableTransaction> builder)
    {
        ...
        builder.Property(b => b.Gateway).HasMaxLength(20);
