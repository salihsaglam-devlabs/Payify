...
public class SubMerchantDailyUsageConfiguration : IEntityTypeConfiguration<SubMerchantDailyUsage>
{
    public void Configure(EntityTypeBuilder<SubMerchantDailyUsage> builder)
    {
