...
public class HostedPaymentTransactionConfiguration : IEntityTypeConfiguration<HostedPaymentTransaction>
{
    public void Configure(EntityTypeBuilder<HostedPaymentTransaction> builder)
    {
        builder.HasIndex(u => u.TrackingId);
