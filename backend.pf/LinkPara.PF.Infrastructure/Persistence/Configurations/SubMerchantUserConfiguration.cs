...
public class SubMerchantUserConfiguration : IEntityTypeConfiguration<SubMerchantUser>
{
    public void Configure(EntityTypeBuilder<SubMerchantUser> builder)
    {
        ...
        builder.Property(b => b.IdentityNumber).HasMaxLength(50);
    }
}
