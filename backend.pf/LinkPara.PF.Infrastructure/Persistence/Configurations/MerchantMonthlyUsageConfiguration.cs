...
{
    public class MerchantMonthlyUsageConfiguration : IEntityTypeConfiguration<MerchantMonthlyUsage>
    {
        public void Configure(EntityTypeBuilder<MerchantMonthlyUsage> builder)
        {
