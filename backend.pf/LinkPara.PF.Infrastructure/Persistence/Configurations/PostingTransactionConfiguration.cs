...
public class PostingTransactionConfiguration : IEntityTypeConfiguration<PostingTransaction>
{
    public void Configure(EntityTypeBuilder<PostingTransaction> builder)
    {
        ...
        builder.Property(b => b.BankPaymentDate).IsRequired().HasColumnType("date");
        ...
        builder.HasIndex(b => new { b.MerchantTransactionId, b.MerchantInstallmentTransactionId }).IsUnique();
        ...
        builder.Property(b => b.IsPerInstallment).IsRequired().HasDefaultValue(false);
    }
}