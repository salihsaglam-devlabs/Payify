...
public class BulkMerchantExcelValidationCommand : IRequest<BulkMerchantExcelValidationResponse>
{
...
public class BulkMerchantExcelValidationCommandHandler : IRequestHandler<BulkMerchantExcelValidationCommand, BulkMerchantExcelValidationResponse>
{
    private readonly IBulkOperationsService _bulkOperationsService;
    
    public BulkMerchantExcelValidationCommandHandler(IBulkOperationsService bulkOperationsService)
    {
        _bulkOperationsService = bulkOperationsService;
    }

    public async Task<BulkMerchantExcelValidationResponse> Handle(BulkMerchantExcelValidationCommand command, CancellationToken cancellationToken)
    {
        return await _bulkOperationsService.PreValidateBulkMerchantExcelFileAsync(command);
    }
}