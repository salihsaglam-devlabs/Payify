...
namespace LinkPara.ApiGateway.Card.Services;
...
public class HttpClientBase
{
        ...
        IHttpContextAccessor contextAccessor)
    {
        ...
        _client.DefaultRequestHeaders.Add("Gateway", Gateway.BoaApiGateway.ToString());//todo
    ...
    private static async Task HandleStandardException(HttpResponseMessage response)
    {
        ...
        { 
            ...
            throw new AuthorizationException(ErrorCode.Unauthorized, $"Card Gateway UnauthorizedAccessException response.StatusCode{response.StatusCode}");
        }
